...
export default function Prores() {
    return (
      <div> 
...
<div className="w-full h-1 mx-4 rounded-lg bg-cyan-500">
      ...
      <div className=" mt-2 mr-4">
        <h6 className="text-base font-bold text-amber-500">Step 1: chose your Dish</h6>
        <p className="text-xs text-white">Explore our delicious menu and select your favorite neal.</p>
      </div>
...
<div className="w-full h-1 mx-4 rounded-lg bg-cyan-500">
      ...
      <div className=" mt-2 mr-4">
        <h6 className="text-base font-bold text-amber-500">Step 2: Custamize your Order{" "}</h6>
        <p className="text-xs text-white">Tailer your meal to your taste.</p>
      </div>
